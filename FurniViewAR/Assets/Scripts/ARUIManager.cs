...
public class ARUIManager : MonoBehaviour
{
    ...
    [SerializeField] private FurnitureSelectionUI furnitureSelectionUI;
    ...
    public void SetState(UIState state)
    {
        ...
        switch (state)
        {
            case UIState.Scanning:
                ...
                SetFurnitureSelectionVisible(false);
                break;
            ...
            case UIState.ReadyToPlace:
                ...
                SetDeleteButtonVisible(false);
                SetFurnitureSelectionVisible(true);
                break;
    ...
    private void SetFurnitureSelectionVisible(bool visible)
    {
        if (furnitureSelectionUI != null)
        {
            furnitureSelectionUI.SetVisible(visible);
        }
    }
